...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/view/css/myScheduleList.css">
</head>
<body>
                ...
                <div class="container" id="scheduleListContainer">
                    <c:forEach var="item" items="${myScheduleList}">
                        <figure class="figure">
                            ...
                            <a href="controller?cmd=myScheduleRouteManageUI&myScheduleId=${item.myScheduleId}"
